...
func TestRejoin2B(t *testing.T) {
	...
	leader1 := cfg.checkOneLeader()
	cfg.disconnect(leader1)
	// fmt.Printf("leader1 disconnected\n")
	...
	leader2 := cfg.checkOneLeader()
	cfg.disconnect(leader2)
	// fmt.Printf("leader2 disconnected\n")

	// old leader connected again
	cfg.connect(leader1)
	// fmt.Printf("leader1 connected\n")

	cfg.one(104, 2, true)

	// all together now
	cfg.connect(leader2)
	// fmt.Printf("leader2 connected\n")
...
func TestBackup2B(t *testing.T) {
	...
	// fmt.Printf("***********************%d(other) disconnected *******************************\n", other)
	...
	// fmt.Printf("**********************all server disconnected*************************\n")
	cfg.connect((leader1 + 0) % servers)
	// fmt.Printf("***********************%d connected *******************************\n", (leader1+0)%servers)
	cfg.connect((leader1 + 1) % servers)
	// fmt.Printf("***********************%d connected *******************************\n", (leader1+1)%servers)
	cfg.connect(other)
	// fmt.Printf("***********************%d(other) connected *******************************\n", other)
	...
	// fmt.Printf("**********************all server connected*************************\n")
	cfg.one(rand.Int(), servers, true)
